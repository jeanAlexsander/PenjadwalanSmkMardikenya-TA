...
<body>
    <nav id="sidebar" class="no-print d-flex flex-column p-3">
        ...
        <div class="d-flex align-items-center justify-content-start mb-3">
            ...
            <span class="no-print text-white fs-5 d-md-none d-inline-block">Kepala Sekolah</span>
        </div>

        {{-- Tulisan Kepala Sekolah (desktop) --}}
        <a href="{{ route('kepala_sekolah.dashboard') }}" class="sidebar-header d-none d-md-flex align-items-center mb-3 text-white text-decoration-none fs-4">
            <span class="fs-4">Kepala Sekolah</span>
        </a>
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <a href="{{ route('kepala_sekolah.dashboard') }}"
                    class="nav-link sidebar-link {{ request()->routeIs('kepala_sekolah.dashboard') ? 'active' : 'text-white' }}">
                    <i class="fas fa-home me-2"></i>
                    <span class="menu-text">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="{{ route('kepala_sekolah.jurusan.index') }}"
                    class="nav-link sidebar-link {{ request()->routeIs('kepala_sekolah.jurusan.*') ? 'active' : 'text-white' }}">
            ...
            <li>
                <a href="{{ route('kepala_sekolah.kelas.index') }}"
                    class="nav-link sidebar-link {{ request()->routeIs('kepala_sekolah.kelas.*') ? 'active' : 'text-white' }}">
                    <i class="fas fa-door-open me-2"></i>
                    <span class="menu-text">Data Kelas Sekolah</span>
                </a>
            </li>
            <li>
                <a href="{{ route('kepala_sekolah.mapel.index') }}"
                    class="nav-link sidebar-link {{ request()->routeIs('kepala_sekolah.mapel*') ? 'active' : 'text-white' }}">
                    <i class="fas fa-book me-2"></i>
                    <span class="menu-text">Data Mata Pelajaran</span>
                </a>
            </li>
            <li>
                <a href="{{ route('kepala_sekolah.penjadwalan.index') }}"
            ...
            <li>
                <a href="{{ route('kepala_sekolah.jadwal_khusus.index') }}"
                    class="nav-link sidebar-link {{ request()->routeIs('kepala_sekolah.jadwal_khusus.*') ? 'active' : 'text-white' }}">
                    <i class="fas fa-calendar-check me-2"></i>
                    <span class="menu-text">Jadwal Khusus</span>
                </a>
            </li>
            <li>
                <a href="{{ route('kepala_sekolah.cetak.index') }}"
                    class="nav-link sidebar-link {{ request()->routeIs('kepala_sekolah.cetak.*') ? 'active' : 'text-white' }}">
                    <i class="fas fa-print me-2"></i>
                    <span class="menu-text">Cetak Jadwal</span>
                </a>
            </li>
            <li>
                <a href="{{ route('kepala_sekolah.profil.index') }}"
                    class="nav-link sidebar-link {{ request()->routeIs('kepala_sekolah.profil.*') ? 'active' : 'text-white' }}">
