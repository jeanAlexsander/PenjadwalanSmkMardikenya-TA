...
@if (Auth::check())
<p class="mb-4">Selamat datang, {{ Auth::user()->guru->name }}!</p>
@else
<p class="mb-4">Selamat datang, Kepala Sekolah (belum login)</p>
@endif

{{-- Kotak Statistik --}}
<div class="row g-3 mb-4">
    <div class="col-12 col-sm-6 col-lg-3">
        <a href="{{ route('kepala_sekolah.mapel.index') }}" class="text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-lg-3">
        <a href="{{ route('kepala_sekolah.kelas.index') }}" class="text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-lg-3">
        <a href="{{ route('kepala_sekolah.guru.index') }}" class="text-decoration-none">
    ...
    <div class="col-12 col-sm-6 col-lg-3">
        <a href="{{ route('kepala_sekolah.jurusan.index') }}" class="text-decoration-none">
