...
<div class="row g-4">
    ...
    <div class="col-md-4">
        <div class="card shadow-sm border-0 bg-warning text-dark">
            <div class="card-body">
                ...
                <span class="badge bg-light text-dark me-1">{{ $gm->mataPelajaran->nama_mata_pelajaran ?? 'Kosong' }}</span>
                @endforeach
            </div>
        </div>
    </div>
    ...
    <!-- Form Ganti Password (rekomendasi) -->
    <div class="col-md-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <span class="badge bg-light text-dark p-2 w-100">Kelas {{ $kelas->nama_kelas }}</span>
                    </div>
                    @empty
                    <div class="col-12">
...
@push('modals')
@include('guru.profil.partials.modal-ganti-password')
@endpush